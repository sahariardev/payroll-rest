...
from .RestControllers.salary_detail_item_controller import SalaryDetailItemListView,SalaryDetailItemDetailView, \
    SalaryDetailItemUpdateView,SalaryDetailItemCreateView
from .RestControllers.production_attendance_type_controller import ProductionAttendanceTypeListView,\
    ProductionAttendanceTypeDetailView, ProductionAttendanceTypeUpdateView,ProductionAttendanceTypeCreateView
